...
sed -i 's/^ro\.build\.version\.release=.*/ro.build.version.release=4.4-omnirom/g' ${ANDROID_HOME}/platforms/android-${SDK_VER}-${CUSTOM_NAME}/build.prop
...
sed -i 's/Pkg.Desc=/Pkg.Desc=OmniROM /' ${ANDROID_HOME}/platforms/android-${SDK_VER}-${CUSTOM_NAME}/source.properties
